...
const DreamHomeCalculator = () => {
  ...
  const rangeConfig = {
    ...
    cost: { min: 100000, max: 20000000, step: 100000, defaultValue: 5000000 },
    loanPercentage: { min: 0, max: 100, step: 1, defaultValue: 80 },
    savings: { min: 0, max: 20000000, step: 10000, defaultValue: 1000000 },
    inflation: { min: 0, max: 20, step: 0.5, defaultValue: 7 },
    returnRate: { min: 0, max: 30, step: 0.5, defaultValue: 9 },
  };
